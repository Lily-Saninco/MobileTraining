/*
 * After this file execute,select the key word from the excel file dataEngine, 
 * if this method inside the class ActionKeywords,it will be executed.
 */
...
public class DriverScriptReflection {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String sPath = System.getProperty("user.dir")+"\\src\\test\\java\\dataEngine\\dataEngine.xlsx";
    	...
    	for (int iRow = 1;iRow <= 9;iRow++){
    		...
    		System.out.println("sActionKeyword1:"+sActionKeyword);
    ...
    private static void execute_Actions() throws Exception {
    	...
    	DriverScriptReflection driverScript= new DriverScriptReflection();
//    	actionKeywords = new ActionKeywords();
//		//This will load all the methods of the class 'ActionKeywords' in it.
//                //It will be like array of method, use the break point here and do the watch
//		method = actionKeywords.getClass().getMethods();
